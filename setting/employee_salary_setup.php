            ...
            <div class="form-group">
              ...
              <select onchange="getDesgInfo(this.value)" name="ddlEmpName" id="ddlEmpName" class="form-control">
                ...
                while ($row_emp = mysqli_fetch_array($result_emp)) { ?>
                  <option <?php if ($emp_name == $row_emp['eid']) {
                            echo 'selected';
                          } ?> value="<?php echo $row_emp['eid']; ?>"><?php echo $row_emp['e_name']; ?></option>
                <?php } ?>
              </select>
            </div>
            <div class="form-group">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="row">
                                        <div class="col-xs-12"> <b><?php echo $_data['text_13']; ?> :</b> <?php echo $row['e_name']; ?><br />
                                          ...
                                          <b><?php echo $_data['text_7']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                      echo $global_currency . $row['amount'];
                                                                                    } else {
                                                                                      echo $row['amount'] . $global_currency;
                                                                                    } ?><br />
