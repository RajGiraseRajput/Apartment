  ...
  <div class="row">
    <div class="col-xs-12">
      <div id="me" class="alert alert-danger alert-dismissable" style="display:<?php echo $delinfo; ?>">
        ...
        <?php echo $_data['delete_owner_utility_information']; ?>
      </div>
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                <div class="col-xs-6">
                                  ...
                                  <b><?php echo $_data['add_new_form_field_text_18']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['rent'];
                                                                                                } else {
                                                                                                  echo $row['rent'] . $global_currency;
                                                                                                } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_8']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                echo $global_currency . $row['water_bill'];
                                                                                              } else {
                                                                                                echo $row['water_bill'] . $global_currency;
                                                                                              } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_9']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                echo $global_currency . $row['electric_bill'];
                                                                                              } else {
                                                                                                echo $row['electric_bill'] . $global_currency;
                                                                                              } ?>
                                </div>

                                <div class="col-xs-6">
                                  <b><?php echo $_data['add_new_form_field_text_10']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['gas_bill'];
                                                                                                } else {
                                                                                                  echo $row['gas_bill'] . $global_currency;
                                                                                                } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_11']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['security_bill'];
                                                                                                } else {
                                                                                                  echo $row['security_bill'] . $global_currency;
                                                                                                } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_12']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['utility_bill'];
                                                                                                } else {
                                                                                                  echo $row['utility_bill'] . $global_currency;
                                                                                                } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_13']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['other_bill'];
                                                                                                } else {
                                                                                                  echo $row['other_bill'] . $global_currency;
                                                                                                } ?><br />
                                  <b><?php echo $_data['add_new_form_field_text_14']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                                                  echo $global_currency . $row['total_rent'];
                                                                                                } else {
                                                                                                  echo $row['total_rent'] . $global_currency;
                                                                                                } ?><br />
