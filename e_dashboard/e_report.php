...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div align="right" style="margin-bottom:1%;"> <a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>e_dashboard.php" data-original-title="<?php echo $_data['back_text']; ?>"><i class="fa fa-reply"></i></a> </div>
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <select name="ddlMonth" id="ddlMonth" class="form-control">
                ...
                while ($row_month = mysqli_fetch_array($result_month)) { ?>
                  <option <?php if ($month_id == $row_month['m_id']) {
                            echo 'selected';
            ...
            <div class="form-group">
              ...
              <select name="ddlYear" id="ddlYear" class="form-control">
                ...
                while ($row_month = mysqli_fetch_array($result_month)) { ?>
                  <option <?php if ($xyear == $row_month['xyear']) {
                            echo 'selected';
                          } ?> value="<?php echo $row_month['xyear']; ?>"><?php echo $row_month['xyear']; ?></option>
                <?php } ?>
              </select>
            </div>
  ...
  <script type="text/javascript">
    function getFairInfo() {
      ...
      if (month_id != '' && xyear != '') {
        ...
        window.open('<?php echo WEB_URL; ?>e_dashboard/e_info_month.php?mid=' + month_id, '_blank');
        //alert('Please select all 3 fields');
      } else if (xyear != '') {
        window.open('<?php echo WEB_URL; ?>e_dashboard/e_info_year.php?yid=' + xyear, '_blank');
        //alert('Please select all 3 fields');
      } else {
