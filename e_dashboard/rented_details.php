      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <table class="table sakotable table-bordered table-striped dt-responsive">
            ...
            <tbody>
              <?php
              $result = mysqli_query($link, "Select *,f.floor_no as ffloor,u.unit_no from tbl_add_rent r inner join tbl_add_floor f on f.fid = r.r_floor_no inner join tbl_add_unit u on u.uid = r.r_unit_no order by r.r_unit_no asc");
