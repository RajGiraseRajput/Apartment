                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body model_view" align="center">&nbsp;
                              <div>
                                <!--<img class="photo_img_round" style="width:100px;height:100px;" src="<?php //echo $event_image;  
                                                                                                        ?>" />-->
                              </div>
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                <div class="col-xs-12">
                                  ...
                                  <b><?php echo $_data['text_2']; ?> :</b> <?php if ($currency_position == 'left') {
                                                                              echo $global_currency . $row['m_amount'];
                                                                            } else {
                                                                              echo $row['m_amount'] . $global_currency;
                                                                            } ?><br />
