	...
	<div class="container"> <br />
		...
		<div class="row text-center ">
			<div class="col-md-12"><br />
				<span style="font-size:18px;color: #dd4b39">Apartment Management System</span>
			</div>
		</div>
		<br />
		<div class="row ">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
				...
				<div class="panel panel-default" id="loginBox">
					<div style="background-color: #dd4b39; padding: 14px 0px 14px 5px" class="">
						<center><strong style="color: white;"> Enter Login Details </strong></center>
					</div>
					<div class="panel-body">
						<form onSubmit="return validationForm();" role="form" id="form" method="post">
							...
							<hr />
							<div align="center">
								<button style="width:100%;background-color: #dd4b39;" type="submit" id="login" class="btn btn-danger"><i class="fa fa-user"></i>&nbsp;Login</button>
							</div>	
						</form>
					</div>
				</div>
