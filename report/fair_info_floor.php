                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($rent_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($rent_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($gas_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($gas_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($electric_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($electric_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($water_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($water_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($security_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($security_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($utility_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($utility_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($other_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($other_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($total_per_month_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($total_per_month_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                    </tr>
                  </tfoot>
                </table>
