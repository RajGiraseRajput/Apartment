          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <select name="ddlVDate" id="ddlVDate" class="form-control">
                ...
                <?php
                $result_floor = mysqli_query($link, "SELECT * FROM tbl_add_bill order by bill_id ASC");
                while ($row_floor = mysqli_fetch_array($result_floor)) { ?>
                  <option <?php if ($bill_date == $row_floor['bill_date']) {
                            echo 'selected';
                          } ?> value="<?php echo $row_floor['bill_date']; ?>"><?php echo $row_floor['bill_date']; ?></option>
                <?php } ?>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select name="ddlYear" id="ddlYear" class="form-control">
                ...
                while ($row_month = mysqli_fetch_array($result_month)) { ?>
                  <option <?php if ($xyear == $row_month['y_id']) {
                            echo 'selected';
                          } ?> value="<?php echo $row_month['y_id']; ?>"><?php echo $row_month['xyear']; ?></option>
                <?php } ?>
              </select>
            </div>
