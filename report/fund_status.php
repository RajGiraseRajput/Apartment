                ...
                <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th style="color:red;">
                        <?php if ($currency_position == 'left') {
                          echo $global_currency . number_format($fund_sub_total, 2, '.', '');
                        } else {
                          echo number_format($fund_sub_total, 2, '.', '') . $global_currency;
                        } ?></th>
                      <th>&nbsp;</th>
                    </tr>
                  </tfoot>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th style="color:red;"><?php if ($currency_position == 'left') {
                                                echo $global_currency . number_format($cost_sub_total, 2, '.', '');
                                              } else {
                                                echo number_format($cost_sub_total, 2, '.', '') . $global_currency;
                                              } ?></th>
                      <th>&nbsp;</th>
                    </tr>
                  </tfoot>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="color:red; font-weight:bold; font-size:16px;">
                        <?php if ($currency_position == 'left') {
                          echo $global_currency . number_format($remain_balance, 2, '.', '');
                        } else {
                          echo number_format($remain_balance, 2, '.', '') . $global_currency;
                        } ?></td>
                    </tr>
                  </tbody>
                </table>
