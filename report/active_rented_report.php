                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                <div class="col-xs-12">
                                  ...
                                  <b>Advance Rent :</b> <?php if ($currency_position == 'left') {
                                                          echo $global_currency . $row['r_advance'];
                                                        } else {
                                                          echo $row['r_advance'] . $global_currency;
                                                        } ?><br />
                                  <b>Rent Per Month :</b> <?php if ($currency_position == 'left') {
                                                            echo $global_currency . $row['r_rent_pm'];
                                                          } else {
                                                            echo $row['r_rent_pm'] . $global_currency;
                                                          } ?><br />
                                  <b>Rent Start Date :</b> <?php echo $row['r_date']; ?><br />
                                  <b>Status :</b> <?php if ($row['r_status'] == '1') {
                                                    echo 'Active';
                                                  } else {
                                                    echo 'Expired';
                                                  } ?><br />
