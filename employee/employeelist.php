  ...
  <div class="row">
    <div class="col-xs-12">
      <div id="me" class="alert alert-danger alert-dismissable" style="display:<?php echo $delinfo; ?>">
        ...
        <?php echo $_data['delete_employee_information']; ?>
      </div>
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <table class="table sakotable table-bordered table-striped dt-responsive">
            ...
            <tbody>
              <?php
              $result = mysqli_query($link, "SELECT *,mt.member_type FROM tbl_add_employee e inner join tbl_add_member_type mt where mt.member_id = e.e_designation and e.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . "");
