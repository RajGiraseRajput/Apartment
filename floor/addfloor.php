...
if (isset($_POST['txtFloor'])) {
	if ($_POST['hdnid'] == '0') {
		...
		$sql = "UPDATE `tbl_add_floor` SET `floor_no`='" . $_POST['txtFloor'] . "' WHERE fid='" . $_POST['hdnid'] . "'";
		mysqli_query($link, $sql);
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-danger">
				...
				<!-- copy and paste to other codes and change the names -->
				<form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="txtFloor">Floor No :</label>
					...
					<input type="hidden" name="hdnid" value="<?php echo $hdnid; ?>" />
				</form>
