...
<body class="skin-red sidebar-mini">
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="dashboard.php" class="logo"><span class="logo-mini">A.M.S.</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">A.M.S.</span></a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar" style="margin-top:10px;">
        ...
        <ul class="sidebar-menu">
          <li class="<?php if ($page_name != '' && $page_name == 'e_dashboard') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard.php"><i class="fa fa-dashboard"></i> <span><?php echo $_data['menu_dashboard']; ?></span></a> </li>
          <li class="<?php if ($page_name != '' && $page_name == 'salary_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/salary_details.php"><i class="fa fa fa-money"></i><span><?php echo $_data['salary_statement']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'e_report') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/e_report.php"><i class="fa fa fa fa-bar-chart-o"></i><span><?php echo $_data['salary_report']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'rented_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/rented_details.php"><i class="fa fa fa-user"></i><span><?php echo $_data['rented_details']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'member_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/member_details.php"><i class="fa fa fa-user"></i><span><?php echo $_data['member_details']; ?></span></a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
